...
class AgcViewer extends HTMLElement {
  ...
  _buildSplatMesh(decoded) {
    ...
    const maxPoints = parseInt(this.getAttribute('max-points') || '80000', 10) || 80000;
      ...
      new THREE.ShaderMaterial({
        ...
        vertexShader: `
          ...
          void main() {
            ...
            // Approximate 2D extent from 3D covariance
            float tr = cov0.x + cov1.x + cov1.z;
            float rad = clamp(sqrt(max(tr, 1e-6)) * 2.0, 0.005, 1.0);
